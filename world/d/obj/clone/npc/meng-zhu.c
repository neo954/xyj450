...
int do_copy(object me, object ob)
{
	...
	ob1 = load_object("/d/obj/clone/npc/shang-shan");
	shangshan = ob1->query("winner");

	if(!( ob2 = find_living("fae")) )
	ob2 = load_object("/d/obj/clone/npc/fa-e");
...
/* copy entire dbase values */
	...
	newone = new("/d/obj/clone/npc/meng-zhu");
	newone->move("/d/suburb/xkx/taishan/fengchan");
	destruct(me);
