...
int do_buy(string arg)
{
       ...
       player = this_player();
       obj = new("/d/suburb/es/latemoon/sell/wine");
    if(!arg )
          return notify_fail("你要买什么东东呀?说清楚嘛! \n");
       else {
      if ( arg == "wine")       { obj= new("/d/suburb/es/latemoon/sell/wine");
                                  amount = 10; }
      if ( arg == "skirt")     { obj= new("/d/suburb/es/latemoon/sell/skirt");
                                 amount = 5; }
      if ( arg == "boots")      { obj= new("/d/suburb/es/latemoon/sell/boots");
                                  amount = 20; }
      if ( arg == "sen-bean")   { obj= new("/d/suburb/es/latemoon/sell/bean");
                                  amount = 50; }
      if ( arg == "heal pill")   { obj= new("/d/suburb/es/latemoon/sell/pill");
                                   amount = 100; }
