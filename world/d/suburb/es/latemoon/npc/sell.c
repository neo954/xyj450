    ...
    if(!arg )
      ...
      switch ( arg )  {
              case "wine" : obj= new("/d/suburb/es/latemoon/sell/wine");
                            amount = 10;
                            break;
              case "skirt" : obj= new("/d/suburb/es/latemoon/sell/skirt");
                             amount = 5;
                             break;
              case "boots" : obj= new("/d/suburb/es/latemoon/sell/boots");
                             amount = 20;
                             break;
              case "sen-bean" : obj= new("/d/suburb/es/latemoon/sell/bean");
                                amount = 50;
                                break;
